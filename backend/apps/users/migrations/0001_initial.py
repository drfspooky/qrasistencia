    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Administrador'), ('admin', 'Administrador Institucional'), ('teacher', 'Docente'), ('student', 'Alumno')], default='student', max_length=20, verbose_name='Rol')),
